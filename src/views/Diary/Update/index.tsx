...
import { ACCESS_TOKEN, DIARY_ABSOLUTE_PATH, DIARY_VIEW_ABSOLUTE_PATH, DIARY_WRITE_ABSOLUTE_PATH } from 'src/constants';
import { PatchDiaryRequestDto, PostDiaryRequestDto } from 'src/apis/dto/request/diary';
import { ResponseDto } from 'src/apis/dto/response';
import { useNavigate } from 'react-router';
import { useParams } from 'react-router';
import GetDiaryResponseDto from 'src/apis/dto/response/diary/get-diary.response.dto';
...
export default function DiaryUpdate() {
  ...
  // fuction: get diary response 처리 함수 //
      ...
      <div className='update-container'>
        ...
        <div className='contents-container'>
          ...
          <div className='button-box'>
            <div className={updateButtonClass} onClick={onUpdateButtonClickHandler}>수정완료</div>
          </div>
        </div>
      </div>
    </div>
