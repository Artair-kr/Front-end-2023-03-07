...
import ConcentraionTest from 'src/types/interfaces/concentration-test.interface';
import ConcentraitonTest from 'src/types/interfaces/concentration-test.interface';
import GetConcentrationResponseDto from 'src/apis/dto/response/test/get-concentration.response.dto';
...
interface TableItemProps {
  concentrationTest: ConcentraionTest
}
...
export default function ConcentrationTestComplete() {
  ...
  const {
    ...
    setTotalList,
    viewList, pageList
  } = usePagination<ConcentraitonTest>();
